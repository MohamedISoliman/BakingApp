 ...
 */
public class BackingAppWidgetConfigureActivity extends Activity {
  ...
  View.OnClickListener mOnClickListener = new View.OnClickListener() {
    public void onClick(View v) {
      final Context context = BackingAppWidgetConfigureActivity.this;
  ...
  public void onCreate(Bundle icicle) {
    ...
    setContentView(R.layout.backing_app_widget_configure);
    ...
    mAppWidgetText.setText(loadTitlePref(BackingAppWidgetConfigureActivity.this, mAppWidgetId));
  }
}
